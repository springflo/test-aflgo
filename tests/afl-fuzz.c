...
EXP_ST u8* trace_bits_vul;             /* SHM with instrumentation vulnerable bitmap, feifuzz */
EXP_ST u8* func_bits;                   /* SHM with instrumentation function map, feifuzz*/
EXP_ST s64* argv_bits;                   /* SHM witn instrumentation instruction argument value, feifuzz*/
