...
if [ ! -e obj-4492-3 ]; then 
	echo "Compile patched version."
	patch -p0 < ../patch-4492
	mkdir obj-4492-3; cd obj-4492-3
...
echo "First Compile."
rm -r obj-4492-1
mkdir obj-4492-1; cd obj-4492-1;
../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
make 
echo "First Compile done."

cd $SUBJECT
TARGET=BUILD/obj-4492-1/binutils/cxxfilt
...
echo "Second compile."
rm -r obj-4492-2
mkdir obj-4492-2; cd obj-4492-2; # work around because cannot run make distclean
../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
make
echo "Second compile done."

cd $SUBJECT 
TARGET=BUILD/obj-4492-2/binutils/cxxfilt
TIME=1m
