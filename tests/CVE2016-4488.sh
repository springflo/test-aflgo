...
if [ ! -e obj-4488-3 ]; then 
	echo "Compile patched version."
	patch -p0 < ../patch-4488
	mkdir obj-4488-3; cd obj-4488-3
...
echo "First Compile."
#rm -rf obj-4488-1
#mkdir obj-4488-1; cd obj-4488-1;
#../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
#make 
echo "First Compile done."

cd $SUBJECT
TARGET=BUILD/obj-4488-1/binutils/cxxfilt
...
echo "Second compile."
#rm -rf obj-4488-2
#mkdir obj-4488-2; cd obj-4488-2; 
#../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
#make
echo "Second compile done."

cd $SUBJECT 
TARGET=BUILD/obj-4488-2/binutils/cxxfilt
TIME=1m
