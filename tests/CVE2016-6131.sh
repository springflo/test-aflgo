...
#### valgind cxxfilt __10%0__S4_0T0T0
echo -e "cplus-dem.c:2360" >$TMP_DIR/BBtargets.txt 
##echo core | sudo tee /proc/sys/kernel/core_pattern
## wget http://ftp.gnu.org/gnu/binutils/binutils-2.26.tar.gz
cd $DOWNLOAD_DIR/BUILD/
if [ ! -e obj-6131-3 ]; then 
	echo "Compile patched version."
	patch -p0 < ../patch-6131
	patch -p0 < ../patch-4489
	mkdir obj-6131-3; cd obj-6131-3
...
echo "First Compile."
#rm -r obj-6131-1
#mkdir obj-6131-1; cd obj-6131-1;
#../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
#make 
echo "First Compile done."

cd $SUBJECT
TARGET=BUILD/obj-6131-1/binutils/cxxfilt
...
echo "Second compile."
#rm -r obj-6131-2
#mkdir obj-6131-2; cd obj-6131-2; # work around because cannot run make distclean
#../configure --disable-shared --disable-gdb --disable-libdecnumber --disable-readline --disable-sim --disable-ld
#make
echo "Second compile done."

cd $SUBJECT 
TARGET=BUILD/obj-6131-2/binutils/cxxfilt
TIME=1m
